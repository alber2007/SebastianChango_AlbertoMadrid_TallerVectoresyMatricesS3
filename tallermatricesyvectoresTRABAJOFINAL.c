...
int main()
{
   ...
   int nalta1,nbaja1;
   nalta1 = estudiantes[1][0];
   nbaja1 = estudiantes[1][0];
   int nalta2,nbaja2;
   nalta2 = estudiantes[2][0];
   nbaja2 = estudiantes[2][0];
   ...
   for (int i = 2 ; i < 3; i++){
      for (int j = 0 ; j < 5; j++){
        ...
        if (estudiantes[i][j] < nbaja2) {
            nbaja2 = estudiantes[i][j];
        }else if (estudiantes[i][j] > nalta2) {
